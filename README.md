...
1. Создать внешний репозиторий c названием TXT.
 2. Клонировать репозиторий TXT на локальный компьютер. - git clone https://github.com/Daryna-QA/TXT.git
 ...
 12. Сделать коммит в одну строку. - git add . && git commit -m "add file skills and preferences"
